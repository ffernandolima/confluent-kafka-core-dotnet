...
namespace Confluent.Kafka.Core.Consumer.Internal
{
    internal static partial class LoggerExtensions
    {
        ...
        [LoggerMessage(
            ...
            Message = "An error has occurred while consuming a message from the topic '{Topic}', partition [{Partition}] and offset @{Offset}. Reason: {Error}.")]
        ...
        [LoggerMessage(
            Level = LogLevel.Error,
            Message = "An error has occurred while executing the interceptor 'OnConsume' for the message #{MessageId}, topic '{Topic}', partition [{Partition}] and offset @{Offset}.")]
        ...
        [LoggerMessage(
            Level = LogLevel.Error,
            Message = "An error has occurred while committing a message from the topic '{Topic}', partition [{Partition}] and offset @{Offset}. Reason: {Error}.")]
        ...
        [LoggerMessage(
            Level = LogLevel.Error,
            Message = "An error has occurred while committing the message #{MessageId} from the topic '{Topic}', partition [{Partition}] and offset @{Offset}. Reason: {Error}.")]
