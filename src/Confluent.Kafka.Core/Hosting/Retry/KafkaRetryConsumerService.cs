...
{
    public sealed class KafkaRetryConsumerService : BackgroundService
    {
        private static readonly Type DefaultServiceType = typeof(KafkaRetryConsumerService);

        private readonly IKafkaRetryConsumerWorker _consumerWorker;

        public KafkaRetryConsumerService(IKafkaRetryConsumerWorker consumerWorker)
        {
